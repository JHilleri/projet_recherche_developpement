...
public:
	...
	inline time_unit delivery_date() const { return m_delivery_date; }
	inline time_unit production_date(index_type machine_index) const { return m_production_dates[machine_index]; }
	inline const_job_ptr job() const { return m_job; }
